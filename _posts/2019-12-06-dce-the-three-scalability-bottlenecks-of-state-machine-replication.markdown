...
New cryptographic techniques allow for **stateless validation**. For example, see [Coda](https://eprint.iacr.org/2020/352.pdf). Alin's [podcast](https://www.zeroknowledge.fm/156) is a great introduction and contains many links.
