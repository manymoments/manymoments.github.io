...
date: 2022-08-14 15:00:00 +03:00
...
3. AS22 holds only against computationally  bounded adversaries (formally, when the *adversary can simulate*), while DR82 works against even against *unbounded adversaries*.
