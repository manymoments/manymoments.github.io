...
* **Blocks** : The protocol reaches agreement on 'blocks', each of which comprise a set of transactions, and contain a cryptographic hash of a parent chain. Each block thus 'extends' and commits to a unique blockchain, which can be thought of as a history or distributed ledger of transactions.
