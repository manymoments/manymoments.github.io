...
SBFT gets a best-case one-round latency. So is it optimal? Again it's a trade-off. While SBFT has the best best-case latency, it has a view change protocol that has _O(n<sup>2</sup>)_ complexity in the worst case. 
