...
It's worth noting that several previous HotStuff variants have a dual leader regimes which inspired HotStuff-2, differentiating between the case of a normal/faulty preceding view; see the [HotStuff-2 manuscript](https://eprint.iacr.org/2023/397.pdf) for a detailed discussion of related works. The first one (to our knowledge) is [Fast-HotStuff](https://arxiv.org/abs/2010.11454), followed by a series of two-phase HotStuff variants. A recent [post](https://decentralizedthoughts.github.io/2022-11-24-two-round-HS/) describes adding a $\Delta$ wait to Tendermint and to the [original two-phase HotStuff paper](https://arxiv.org/pdf/1803.05069v1.pdf), but with no discussion of responsiveness or view synchronization.  
