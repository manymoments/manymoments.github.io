...
In distributed computing we model the communication uncertainty by an **adversary** that can control the message delays. The **communication model** defines the limits to the power of the adversary to delay messages. 

There are three basic communication models: Synchrony, Asynchrony and Partial Synchrony.
