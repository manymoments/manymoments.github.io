...
*if there are only three people $A,B,C$ and say $B$ and $C$ blame each other for being corrupt and lying, then $A$ has no way to decide correctly between $B$ and $C$: who to trust and who to label as corrupt.* 
