...
In this second part of the [series on Encrypted Blockchain Databases](..part...one...), we are going to describe three schemes to store dynamic encrypted multi-maps on blockchains, each of which achieves different tradeoffs between query, add and delete efficiency. 
